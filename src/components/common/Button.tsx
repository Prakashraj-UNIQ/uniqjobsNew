...
type ButtonVariant = "filled" | "outline" | "icon" | "iconFilled" | "filedBlack" | "filedBlackMin";
...
export default function Button({
    ...
    const variant: Record<ButtonVariant, string> = {
        ...
        outline: "border px-8 py-2 text-white lg:text-black rounded-full bg-white hover:bg-brandRed hover:text-white transition font-semibold self-start sm:self-start",
        icon: "py-2 px-5 rounded-full border border-brandBlue hover:bg-brandBlue/5 transition text-brandBlue",
        iconFilled: "py-2 px-5 rounded-full border border-brandBlue hover:bg-brandBlue/5 transition text-brandBlue"
    }
